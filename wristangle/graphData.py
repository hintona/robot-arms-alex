...
def graphData():
    ...
    with open('wristangle/processedWristAngle1.csv','r')as firstFile:
    ...
    with open('wristangle/processedWristAngle2.csv','r')as firstFile:
        csvReader = csv.reader(firstFile)
    ...
    with open('wristangle/processedWristAngle3.csv','r')as firstFile:
        csvReader = csv.reader(firstFile)
    ...
    with open('wristangle/processedWristAngle4.csv','r')as firstFile:
        csvReader = csv.reader(firstFile)
    ...
    with open('wristangle/processedWristAngle5.csv','r')as firstFile:
        csvReader = csv.reader(firstFile)
