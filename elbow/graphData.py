...
def graphData():
    ...
    with open('elbow/processedElbow1.csv','r')as firstFile:
    ...
    with open('elbow/processedElbow2.csv','r')as firstFile:
        csvReader = csv.reader(firstFile)
    ...
    with open('elbow/processedElbow3.csv','r')as firstFile:
        csvReader = csv.reader(firstFile)
    ...
    with open('elbow/processedElbow4.csv','r')as firstFile:
        csvReader = csv.reader(firstFile)
    ...
    with open('elbow/processedElbow5.csv','r')as firstFile:
        csvReader = csv.reader(firstFile)
